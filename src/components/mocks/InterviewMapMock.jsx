        ...
        <ul className="mt-4 flex flex-wrap items-center gap-x-2 gap-y-3">
            {FUNCTIONS.map((name, index) => (
                <li key={name} className="flex items-center gap-2">
                    <span className="rounded-xl border border-slate-300 bg-stone-100 px-3 py-2 text-xs font-bold text-slate-800 dark:border-white/20 dark:bg-white/[0.06] dark:text-slate-100">
                        {name}
                    </span>
        ...
        <div className="mt-7 border-t border-slate-200 pt-6 dark:border-white/10">
            ...
            <div className="mt-4 flex items-stretch gap-3">
                ...
                <div className="flex-1">
                    <div className="relative h-44 rounded-xl border border-slate-200 bg-stone-100 dark:border-white/10 dark:bg-white/[0.05]">
